...
""",
    ...
    parser_2d.add_argument(
        "--margin", type=float, default=0.5, help="Canvas margin in coordinate units (default: 0.5)"
    )
    parser_2d.add_argument(
        "--bond-length",
        type=float,
    ...
    # 3D Canvas Settings
    parser_3d.add_argument(
        "--width", type=int, default=1320, help="Render width in pixels (default: 1320)"
    )
    parser_3d.add_argument(
        "--height", type=int, default=990, help="Render height in pixels (default: 990)"
    )
    parser_3d.add_argument(
        "--bg-color",
